...
<body>
    ...
    <section id="carousel">
      ...
      <h2>Connexion</h2>
        ...
        <div class="input-groupes" style="margin: auto; width: 65%; height: 50px; background-color: white; border-radius: 5px; align-items: center; display: flex; justify-content: center;">
            <!-- Mot de passe -->
